...
class OnOff:
    ...
    def str(self):
        return "ison:" + str(self.ison) + " info:" + ("" if self.info is None else self.info)
...
class Provider:
    ...
    def __init__(self, operation = None):
        self.operation = operation if operation is not None else FakeOp()
        self.org = self.operation.org
